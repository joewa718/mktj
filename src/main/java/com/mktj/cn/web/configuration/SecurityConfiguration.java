...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers("/css/**", "/js/**", "/tpl/**","/plugin/**", "/imageupload/**",  "/images/**", "/vendor/**", "/*.html", "/", "/fonts/**", "/l10n/**", "/**/favicon.ico", "/webjars/springfox-swagger-ui/**", "/swagger-resources/**", "/v2/**","/api/user/login","/api/user/regUser","/api/user/captcha","/api/wechat/portal/**","/api/wechat/user/**").permitAll()
